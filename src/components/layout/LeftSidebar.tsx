        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-16 left-0 bottom-0 w-64 bg-white border-r border-slate-100 z-50 lg:hidden"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-100">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 mb-1"
                >
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-slate-100 flex-col z-50">
        ...
        <div className="p-6 border-b border-slate-100">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => onNavigate('dashboard')}>
            ...
            <span className="text-xl font-bold text-slate-900">AuditReady</span>
          </div>
        </div>
              ...
              {isUserMenuOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-xl shadow-lg border border-slate-100 p-2 z-50"
                  >
                    <button
                      onClick={() => {
